...
<body>
	<div class="row" style="border-radius: 20px;background-color: white;opacity: 0.90;">
		<div class="col-xs-12 col-md-10">
			...
			// AFFICHER LE RESULTAT DE LA CONNEXION
	...
	<div class="row" style="border-radius: 20px;background-color: white;opacity: 0.90;">
		<div class="col-xs-12 col-md-10">
			<fieldset>
				<h1 class="text-center"><i class="fa fa-plus"></i> S'inscrire</h1>
				<form method="post" action="index.php?uc=gererConnexion&action=connexion&option=inscription" class="form-horizontal">
					<div class="col-md-6">
						<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<button type="submit" class="btn btn-success"><i class="fa fa-plus"></i> S'inscrire</button>
						</div>
					</div>
				</form>
			</fieldset>
