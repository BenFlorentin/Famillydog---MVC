				...
				if(isset($_SESSION['user_id']))
				{
					...
					if($_SESSION['user_droit'] != 1)
					{
						...
						<li class="dropdown">
							<div class="dropdown" style="top: 20px; margin-right: 10px;">
								<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" data-hover="dropdown" >
									<i class="fa fa-user"></i> <?php echo strtoupper($_SESSION['user_nom']).' '. ucfirst($_SESSION['user_prenom']); ?> <span class="caret"></span>
								</button>
								<ul class="dropdown-menu">
									<li><a href="compte_infos.php"><i class="fa fa-info"></i> Mes informations</a></li>
									<li><a href="animaux.php"><i class="fa fa-paw"></i> Mes animaux</a></li>
									<li class="dropdown">
										<a tabindex="-1" href="reservations.php"><i class="fa fa-calendar"></i> Mes réservations</a>
										<ul class="dropdown-menu">
											<li>
												<?php 
												// réservations non payées
												/*$me = $bdd->prepare('SELECT COUNT(*) AS nb_non_payees FROM reservation WHERE etat = ? AND ID_proprietaire = ?');
												$me->execute(array('NP', $_SESSION['user_id']));
												$message = $me->fetch();*/

												if($nbReservationsUtilisateurNonPayees == 0)
												{
													echo'<li><a href="#" disabled="disabled">Non payée <span class="badge" style="background-color:green">0</span></a></li>';	 	
												}
												if($nbReservationsUtilisateurNonPayees == 1)
												{
													echo'<li><a href="reservations_non_payees.php">Non payée <span class="badge" style="background-color:red">1</span></a></li>';	 	
												}
												if($nbReservationsUtilisateurNonPayees > 1)
												{
													echo'<li><a href="reservations_non_payees.php">Non payées <span class="badge" style="background-color:red">'.$nbReservationsUtilisateurNonPayees.'</span></a></li>';	 	
												}
											...
											<li>
												<?php 
												// réservations payéees
												/*$me = $bdd->prepare('SELECT COUNT(*) AS nb_payees FROM reservation WHERE etat = ? AND ID_proprietaire = ?');
												$me->execute(array('P', $_SESSION['user_id']));
												$message = $me->fetch();*/

												if($nbReservationsUtilisateurPayees == 0)
												{
													echo'<li><a href="#" disabled="disabled">Payée <span class="badge" style="background-color: green">0</span></a></li>';	 	
												}
												if($nbReservationsUtilisateurPayees == 1)
												{
													echo'<li><a href="reservations_payees.php">Payée <span class="badge" style="background-color: red">1</span></a></li>';	 	
												}
												if($nbReservationsUtilisateurPayees > 1)
												{
													echo'<li><a href="reservations_payees.php">Payées <span class="badge" style="background-color: red">'.$nbReservationsUtilisateurPayees.'</span></a></li>';	 	
												}
											...
											<li>
												...
												/*$me = $bdd->prepare('SELECT COUNT(*) AS nb_en_cours FROM reservation WHERE etat = ? AND ID_proprietaire = ?');
												$me->execute(array('E', $_SESSION['user_id']));
												$message = $me->fetch();*/

												if($nbReservationsUtilisateurEnCours == 0)
												{
													echo'<li><a href="#" disabled="disabled">En cours <span class="badge" style="background-color: green">0</span></a></li>';	 	
												}
												if($nbReservationsUtilisateurEnCours == 1)
												{
													echo'<li><a href="reservations_en_cours.php">En cours <span class="badge" style="background-color: red">1</span></a></li>';	 	
												}
												if($nbReservationsUtilisateurEnCours > 1)
												{
													echo'<li><a href="reservations_en_cours.php">En cours <span class="badge" style="background-color: red">'.$nbReservationsUtilisateurEnCours.'</span></a></li>';	 	
												}
											...
											<li>
												<?php 
												// réservations terminées
												/*$me = $bdd->prepare('SELECT COUNT(*) AS nb_terminees FROM reservation WHERE etat = ? AND ID_proprietaire = ?');
												$me->execute(array('T', $_SESSION['user_id']));
												$message = $me->fetch();*/

												if($nbReservationsUtilisateurTerminees == 0)
												{
													echo'<li><a href="#" disabled="disabled">Terminée <span class="badge" style="background-color: green">0</span></a></li>';	 	
												}
												if($nbReservationsUtilisateurTerminees == 1)
												{
													echo'<li><a href="reservations_terminees.php">Terminée <span class="badge" style="background-color: red">1</span></a></li>';	 	
												}
												if($nbReservationsUtilisateurTerminees > 1)
												{
													echo'<li><a href="reservations_terminees.php">Terminées <span class="badge" style="background-color: red">'.$nbReservationsUtilisateurTerminees.'</span></a></li>';	 	
												}
											...
											<li role="separator" class="divider"></li>
											<li><a href="reservations.php"><i class="fa fa-calendar"></i> Mes réservations</a></li>
										</ul>
									</li>
									<li role="separator" class="divider"></li>
