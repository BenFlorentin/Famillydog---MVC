...
<body>
	<div class="container">
      ...
      ?>
			...
			<form method="post" action="reserver_date_post.php" class="form-horizontal">
				<div class="col-md-6">
					<div class="form-group">
						<label for="from" class="col-sm-2 control-label" name="from">Début </label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="from" placeholder="ex :dd/mm/aaaa" name="from" required>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="to" placeholder="ex :dd/mm/aaaa" name="to" required>
						</div>
					</div>
				</div>
				<div class="form-group">
