...
<div class="container">
	<h1 class="test-center"><i class="fa fa-calendar-times-o"></i> Réservations - Non payées</h1>
	<fieldset>
		<div class="table-responsive ">
			<table class="table table-striped table-condensed">
				...
				$u = $bdd->prepare('SELECT * FROM reservation
					...
					AND ID_proprietaire = ?
					ORDER BY date_debut');
				$u->execute(array('NP', $_SESSION['user_id']));
							...
							<tr>
								...
								<td>
									<form method="post" action="reservation_supprimer.php" class="form-horizontal">
										<input type="hidden" value="<?php echo $reservation['ID'];?>" name="ID_reservation"/>
										<input type="hidden" value="admin" name="admin"/>
										<button type="submit" class="btn btn-danger"><i class="fa fa-calendar-times-o"></i> Supprimer</button>
									</form>
								</td>
							</tr>
